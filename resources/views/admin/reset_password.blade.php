...
<div class="login-box">
    <div class="login-logo">
        <a href="{{url('design/adminlte')}}/index2.html"><b>Admin</b>Reset Password</a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
...
@if($errors->all())
    ...
    @endif
            <form  method="post">
                ...
                <div class="input-group mb-3">
                    <input type="password" name="password_conformation" class="form-control" placeholder="Enter conformation Password">
                    <div class="input-group-append">
                        <div class="input-group-text">
                            <span class="fas fa-lock"></span>
                        </div>
